...
par(mar=c(4,4,1,2))
plot(x, y3, type ="l", xlab = NULL, ylab="Energy sub metering")
points(x,y4,col="red", type="l")
points(x,y5,col="blue", type ="l")

legend("topright", bty = "n", cex=0.5, xjust= 1, legend=c("-- Sub_metering_1", "-- Sub_metering_2", "-- Sub_metering_3"), text.col=c("black", "red", "blue"))
